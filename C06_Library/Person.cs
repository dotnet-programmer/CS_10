...
public class Person : object, IComparable<Person>
{
	...
	// metody
	public void WypiszWKonsoli() => Console.WriteLine($"{Nazwisko}, data urodzenia {DataUrodzenia:dddd}.");
	...
	public Person ProkreacjaZ(Person partner) => Prokreacja(this, partner);

	// operator "mnożenia"
	public static Person operator *(Person o1, Person o2) => Person.Prokreacja(o1, o2);
	...
	public static int Silnia(int liczba)
	{
		...
		// funkcja lokalna
		static int lokalnaSilnia(int lokalnaLiczba) => lokalnaLiczba < 1 ? 1 : lokalnaLiczba * lokalnaSilnia(lokalnaLiczba - 1);
	}
	...
	public int CompareTo(Person? other) => Nazwisko is null ? 0 : Nazwisko.CompareTo(other?.Nazwisko);

	public override string ToString() => $"{Nazwisko} to {base.ToString()}";
